...
nnumber= 8; #network number in networks¥ file L (in file MatricesX.rdata)
...
#--------------------------------------------
	...
	tempL=c();
      ...
      #updates number of agent¥s uttered conventions
...
#----------------------------------------------------------------
	...
	tempL=c();
     ...
     #updates agent¥s uttered conventions
	wUttered[nagent]= wUttered[nagent]+1;
...
#----------------------------------------------------------------
	...
	tempL=c();
     ...
     #updates neighbor¥s conventions
	temp = wHeardReservoir[[nword]][neighbor];
if(mesaIndice[[nword]][1]==1)
{	if(temp==thresEasy)
	{ 
